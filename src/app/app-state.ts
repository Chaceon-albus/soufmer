...
export type AppState =
  ...
  | { type: "cancelling"; taskId: string; environment: EnvironmentStatus; settings: AppSettings; outputDirectory?: string; initializationRequest?: StartBatchRequest; lastProgress?: BatchProgress | InitializationProgress }
