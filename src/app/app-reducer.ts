...
export function appReducer(state: AppState, action: AppAction): AppState {
  switch (action.type) {
    ...
    case "dismissed": return state.type === "completed" || state.type === "failed" || state.type === "awaitingInitializationConsent" ? { type: "idle", environment: action.environment, settings: action.settings } : state;
  }
}
