...
export const pathKindInfoSchema = z.object({ exists: z.boolean(), isDir: z.boolean(), isFile: z.boolean(), parentDir: z.string().optional() });
export type PathKindInfo = z.infer<typeof pathKindInfoSchema>;
