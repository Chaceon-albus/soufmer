...
selected Gyan.D FFmpeg 8.0.1 essentials build is GPL-3.0 and its exact archive license is embedded.
PyTorch, torchaudio, the private Python distribution, Tauri, and
